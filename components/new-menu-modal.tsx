...
export function NewMenuModal({
  ...
  const handleChangeImage = async () => {
    ...
    if (uploadedImageUrl) {
      try {
        // Extract path from URL: menus/uuid.ext
        // URL format: https://xxxxx.supabase.co/storage/v1/object/public/menus/uuid.ext
        const pathParts = uploadedImageUrl.split("/public/")
        const filePath = pathParts[1] // Gets "menus/uuid.ext"
